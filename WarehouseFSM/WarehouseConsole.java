...
public class WarehouseConsole {
    ...
    public void receiveProductShipment(Scanner scanner) {
...
private void fulfillWaitlist(Product product) {
    ...
    public void addProductToWishlist(Scanner scanner, Client client) {
    ...
    public void processWishlistPurchase(Client client) {
    ...
    public void manageClients(Scanner scanner) {
        ...
        System.out.println("Client added successfully! id is: " + client.getID());
        clientCount++;
    }
